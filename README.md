...
Our minor improvements:

- Improve the 'overnight' dataset by 1) testing only on unseen logical forms 2) adding more entities in the KB and test on unseen entities. This dataset is used for the paper *Symbolic Priors for RNN-based Semantic Parsing* (IJCAI 2017) 
